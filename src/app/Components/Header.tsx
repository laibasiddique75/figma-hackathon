...
<header className="p-3 bg-white shadow">
  <div className="container">
    <div className="d-flex flex-wrap align-items-center justify-content-between">
      {/* Hamburger Menu Icon */}
      <button
        className="d-lg-none border-0 bg-transparent me-3"
      ...
      >
        ...
        <li>
          <a href="http://localhost:3000/" className="nav-link px-2 text-black">
            Brands
          </a>
        </li>
        <Link href="/ProductDetailPage" className="nav-link px-2 text-black">
          Product Detail Page
        </Link>
        <Link href="/Category" className="nav-link px-2 text-black">
          Category
        </Link>
        <Link href="/Cart" className="nav-link px-2 text-black">
          Cart
        </Link>
